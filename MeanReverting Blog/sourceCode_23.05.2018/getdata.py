...
class GetData(object):
    ...
    def __init__(self,exchange, directory, newdata=False):
    ...
    def fetch(self, ticker):
        if self.exchange == 'poloniex':
            ...
            if (not os.path.isfile(directory)) or self.newdata==True:
                ...
                if not os.path.exists(self.directory+'/Raw_data/'+self.exchange+'/5m'):
                    os.makedirs(self.directory+'/Raw_data/'+self.exchange+'/5m')
